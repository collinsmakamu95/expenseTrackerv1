...
import 'package:expensetracker/mainInterfaces/upcomingTransactionsInterface.dart';
import 'package:expensetracker/mainInterfaces/transactionsInterface.dart';
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: ((context) => PastTransactionsInterface())));
                          },
                          child: Text(
                            "-€540.26",
                            style: TextStyle(
